...
enum Agg_Type {
	...
	NonAgg_Ack,
	NonAgg_AckAck,
	DataCollection_Start,
	DataCollection_Data,
	DataCollection_Ack,
	DataCollection_AckAck,
	Agg_TYPES
};
...
typedef struct DataCollectionStartMsg {
	uint16_t dl_dst;
	uint16_t dl_src;
	uint8_t type; // =NonAgg_Start
} DataCollectionStartMsg;

typedef struct DataCollectionDataMsg {
	uint16_t dl_dst;
	uint16_t dl_src;
	uint16_t sent;
	uint16_t received;
	...
	uint16_t src;
	uint16_t final;
} DataCollectionDataMsg;

typedef struct DataCollectionAckMsg {
	uint16_t dl_dst;
	uint16_t dl_src;
	uint8_t type;
} DataCollectionAckMsg;

typedef struct DataCollectionAckAckMsg {
	uint16_t dl_dst;
	uint16_t dl_src;
	uint8_t type;
} DataCollectionAckAckMsg;
#endif
